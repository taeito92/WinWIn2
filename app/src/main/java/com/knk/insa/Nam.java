...
public class Nam implements InsaM {
  ...
  public void up() {
    ...
    if(!sc.nextLine().equals("y")) {
      System.out.println("이름변경을 취소하였습니다.");
    ...
    if(!sc.nextLine().equals("y")) {
      System.out.println("직급변경을 취소하였습니다. ");

    }
    System.out.println("------------------------------");
    System.out.print("변경할 직급 입력 : ");
    String uJg = sc.nextLine();
    System.out.println(uJg +"로 직급이 변경되었습니다.");

    System.out.println("");
    System.out.println("------------------------------");
    System.out.print("연봉을 변경하시겠습니까? (y/N) ");
    if(!sc.nextLine().equals("y")) {
      System.out.println(" 급여변동 X ");
    ...
    System.out.printf( " %d 로 이동 " , uPhone);
